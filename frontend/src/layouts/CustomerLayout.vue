  ...
  <div class="layout">
    ...
    <div :class="['sidebar', { open: sidebarOpen }]">
      ...
      <nav class="sidebar-nav">
        <router-link to="/dashboard" class="sidebar-item" exact-active-class="sidebar-item--active" active-class="" @click="sidebarOpen = false">Yeni Rezervasyon</router-link>
        <router-link to="/dashboard/rezervasyonlar" class="sidebar-item" active-class="sidebar-item--active" @click="sidebarOpen = false">Rezervasyonlarım</router-link>
      </nav>
    </div>
...
.user-badge {
  padding: 6px 14px; background: #ede9fe; color: #6366f1;
