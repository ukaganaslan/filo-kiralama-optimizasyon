      ...
      <div class="sidebar-brand">
        <router-link to="/dashboard" class="brand-link" @click="mobileOpen = false">
          ...
          <div class="brand-text">
            ...
            <div class="brand-role">Müşteri Paneli</div>
          </div>
        </router-link>
      ...
      <div class="sidebar-footer">
        <template v-if="!collapsed">
          <div class="footer-user-row">
            ...
            <router-link to="/dashboard/profil" class="footer-icon-btn" title="Profil Ayarları" @click="mobileOpen = false">
        ...
        <template v-else>
          <div class="footer-collapsed">
            ...
            <router-link to="/dashboard/profil" class="footer-icon-btn-sm" title="Profil Ayarları">
